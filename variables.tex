...
\newcommand {\TheName} { TheName }

\newcommand {\Title} {\TheName: Fast Visualization of Large Architectural Models}
...
\newcommand {\Supervisors} { António Menezes Leitão}
...
\newcommand {\Advisor} {{\large Prof. Dr. António  Menezes  Leitão}}
